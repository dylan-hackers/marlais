...
#define CLASSABSTRACTP(obj)      (marlais_is_class_p (obj) && (CLASSPROPS (obj) & MARLAIS_CLASS_ABSTRACT))
#define CLASSDEFINEDP(obj)      (marlais_is_class_p (obj) && (CLASSPROPS (obj) & MARLAIS_CLASS_DEFINED))
#define CLASSIMMEDIATEP(obj)    (marlais_is_class_p (obj) && (CLASSPROPS (obj) & MARLAIS_CLASS_IMMEDIATE))
#define CLASSPRIMARYP(obj)      (marlais_is_class_p (obj) && (CLASSPROPS (obj) & MARLAIS_CLASS_PRIMARY))
#define CLASSSEALEDP(obj)      (marlais_is_class_p (obj) && (CLASSPROPS (obj) & MARLAIS_CLASS_SEALED))
#define CLASSBUILTINP(obj)      (marlais_is_class_p (obj) && (CLASSPROPS (obj) & MARLAIS_CLASS_BUILTIN))
#define CLASSUNINITIALIZED(obj)  (marlais_is_class_p (obj) && (CLASSPROPS (obj) & MARLAIS_CLASS_UNINITIALIZED))
